...
0000000000400f43 <phase_3>:
  ...
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>  ;should jump
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>  ;dont jump
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)  ;间接跳转,switch
  ...
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>  ;should jump
...
0000000000400fce <func4>:
  ...
  400fd2:	89 d0                	mov    %edx,%eax ;int ret = input3
  400fd4:	29 f0                	sub    %esi,%eax ;ret -= input2
  400fd6:	89 c1                	mov    %eax,%ecx ;int input4 = ret
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx ;input4 = input4 >> 31
  400fdb:	01 c8                	add    %ecx,%eax ;ret += input4
  400fdd:	d1 f8                	sar    %eax  ;ret = ret >> 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx  ;input4 = ret + input2
  400fe2:	39 f9                	cmp    %edi,%ecx  ;if(input4 <= input1)
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24> ;jmp pos1
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx  ;else input3 = input4 - 1
  400fe9:	e8 e0 ff ff ff       	callq  400fce <func4> 
  400fee:	01 c0                	add    %eax,%eax  ;ret += ret
  400ff0:	eb 15                	jmp    401007 <func4+0x39>
 ;pos1:
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax ;ret = 0
  400ff7:	39 f9                	cmp    %edi,%ecx  ;if(input4 >= input1)
  400ff9:	7d 0c                	jge    401007 <func4+0x39>  ;jmp pos2
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi   ;else input2 = input4 + 1
  400ffe:	e8 cb ff ff ff       	callq  400fce <func4>
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax  ;ret = 2ret + 1
 ;pos2:
...
000000000040100c <phase_4>:
  ...
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx ;second input
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx ;first input
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi ;"%d %d"
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	callq  400bf0 <__isoc99_sscanf@plt> ;should return 2
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29> ;dont jump
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)
  401033:	76 05                	jbe    40103a <phase_4+0x2e> ;should jump
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx
  40103f:	be 00 00 00 00       	mov    $0x0,%esi
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi
  401048:	e8 81 ff ff ff       	callq  400fce <func4> ;should return 0
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c> ;dont jump
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)
  401056:	74 05                	je     40105d <phase_4+0x51> ;should jump
